...
const SidebarNav = () => {
  ...
  return (
    <nav>
      <header className="w-full h-screen min-w-[300px] border-t border-r border-slate-400 p-5">
        <h1 className="text-2xl font-semibold mb-8 line-clamp-1">GEN Studio</h1>

        <div className=" relative flex w-full my-4  h-[64px] p-3 gap-3 rounded-xl justify-between items-center cursor-pointer group before:absolute before:inset-0 before:bg-slate-100 before:rounded-xl before:hover:scale-105 before:transition before:duration-200">
