...
const CartSlide = () => {
  ...
  return (
    <>
      ...
      <div
        className={`overflow-y-scroll max-w-[450px] p-6 w-full border fixed z-[9] right-0 h-full top-0 bg-white transform ${
          state === "cart" ? "translate-x-[0%]" : "translate-x-[100%]"
        } transition-all duration-300`}
      >
        <div className="cart max-w-[500px] p-4 w-full absolute right-0 min-h-dvh bg-[#fefefe]">
